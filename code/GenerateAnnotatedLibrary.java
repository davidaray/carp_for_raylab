...
public class GenerateAnnotatedLibrary {
	...
	private static String oDir = "finallibrary/";
	...
	private static String GBTE = iDir + "annotationfiles/GB_TE.fa";
	private static String ERVgff = iDir + "results_classify/notKnown.fa.ervwb.gff";
	private static String ALLR = iDir + "annotationfiles/all_retrovirus.fasta";
	private static String SSR = iDir + "results_classify/SSR.txt";
	private static String Proteins = iDir + "results_classify/protein.txt";
