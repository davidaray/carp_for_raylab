...
public class GetProteins {
	...
	private static String pDir = "ProteinReport/";
	private static String data = pDir + "notKnown.fa";
	private static String ipFile = data + ".spwb.gff";
	private static String opFile = dDir + "protein.txt";
	private static String nknpFile = pDir + "notKnownNotProtein.fa";
